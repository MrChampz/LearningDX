...
LitWavesApp::LitWavesApp(HINSTANCE hInst)
	: D3DApp(hInst)
{
...
void LitWavesApp::Update(const GameTimer& timer)
{
...
void LitWavesApp::Draw(const GameTimer& timer)
{
...
void LitWavesApp::OnKeyboardInput(const GameTimer& timer)
{
	...
	if (GetAsyncKeyState(VK_LEFT) & 0x8000)
		m_SunTheta -= 1.0f * timer.DeltaTime();

	if (GetAsyncKeyState(VK_RIGHT) & 0x8000)
		m_SunTheta += 1.0f * timer.DeltaTime();

	if (GetAsyncKeyState(VK_UP) & 0x8000)
		m_SunPhi -= 1.0f * timer.DeltaTime();
...
void LitWavesApp::UpdateCamera(const GameTimer& timer)
{
...
void LitWavesApp::UpdateObjectCBs(const GameTimer& timer)
{
...
void LitWavesApp::UpdateMaterialCBs(const GameTimer& timer)
{
...
void LitWavesApp::UpdateMainPassCB(const GameTimer& timer)
{
...
void LitWavesApp::UpdateWaves(const GameTimer& timer)
{
...
void LitWavesApp::DrawRenderItems(ID3D12GraphicsCommandList* cmdList, const std::vector<Renderable*>& renderables)
{
