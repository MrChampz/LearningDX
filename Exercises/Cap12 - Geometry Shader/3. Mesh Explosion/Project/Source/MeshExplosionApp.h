...
class MeshExplosionApp : public D3DApp
{
public:
	MeshExplosionApp(HINSTANCE hInst);
	MeshExplosionApp(const MeshExplosionApp& rhs) = delete;
	MeshExplosionApp& operator=(const MeshExplosionApp& rhs) = delete;
	~MeshExplosionApp();
