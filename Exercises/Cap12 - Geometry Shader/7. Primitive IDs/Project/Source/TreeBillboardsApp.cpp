...
void TreeBillboardsApp::BuildShadersAndInputLayout()                       
{
	...
	m_Shaders["TreeBillboardVS"] = D3DUtil::CompileShader(L"../Shaders/TreeBillboard_VS.hlsl", nullptr, "VS", "vs_5_0");
	m_Shaders["TreeBillboardGS"] = D3DUtil::CompileShader(L"../Shaders/TreeBillboard_GS.hlsl", nullptr, "GS", "gs_5_0");
	m_Shaders["TreeBillboardPS"] = D3DUtil::CompileShader(L"../Shaders/TreeBillboard_PS.hlsl", alphaTestedDefines, "PS", "ps_5_0");
