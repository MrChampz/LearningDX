...
{
	GeometryGenerator::MeshData ico = GeometryGenerator::CreateGeosphere(5.0f, 0);
...
void CylinderApp::BuildRenderItems()
{
	...
	m_RenderableLayer[(int)RenderLayer::Cylinder].push_back(icoItem.get());
...
void CylinderApp::BuildPSOs()
{
	...
	cylinderPsoDesc.RasterizerState.FillMode = D3D12_FILL_MODE_WIREFRAME;
