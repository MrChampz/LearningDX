...
{
	m_BlurFilter->OnKeyboardInput(timer);
...
void Application::UpdateWaves(const GameTimer& timer)
{
...
void Application::BuildShadersAndInputLayout()                       
{
	...
	m_Shaders["HorzBlurCS"] = D3DUtil::CompileShader(L"../Shaders/Blur_CS.hlsl", nullptr, "HorzBlurCS", "cs_5_0");
	m_Shaders["VertBlurCS"] = D3DUtil::CompileShader(L"../Shaders/Blur_CS.hlsl", nullptr, "VertBlurCS", "cs_5_0");
