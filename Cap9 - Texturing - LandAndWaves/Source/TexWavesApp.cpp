...
TexWavesApp::TexWavesApp(HINSTANCE hInst)
	: D3DApp(hInst)
{
...
void TexWavesApp::Update(const GameTimer& timer)
{
...
void TexWavesApp::Draw(const GameTimer& timer)
{
...
void TexWavesApp::OnKeyboardInput(const GameTimer& timer)
{
...
void TexWavesApp::AnimateMaterials(const GameTimer& timer)
{
...
void TexWavesApp::UpdateCamera(const GameTimer& timer)
{
...
void TexWavesApp::UpdateObjectCBs(const GameTimer& timer)
{
...
void TexWavesApp::UpdateMaterialCBs(const GameTimer& timer)
{
...
void TexWavesApp::UpdateMainPassCB(const GameTimer& timer)
{
...
void TexWavesApp::UpdateWaves(const GameTimer& timer)
{
...
void TexWavesApp::BuildRenderItems()
{
	...
	m_RenderableLayer[(int)RenderLayer::Opaque].push_back(boxItem.get());
...
void TexWavesApp::DrawRenderItems(ID3D12GraphicsCommandList* cmdList, const std::vector<Renderable*>& renderables)
{
