...
void CrateApp::Update(const GameTimer& timer)
{
...
void CrateApp::Draw(const GameTimer& timer)
{
...
void CrateApp::OnKeyboardInput(const GameTimer& timer)
{
...
void CrateApp::UpdateCamera(const GameTimer& timer)
{
...
void CrateApp::UpdateObjectCBs(const GameTimer& timer)
{
...
void CrateApp::UpdateMaterialCBs(const GameTimer& timer)
{
...
void CrateApp::UpdateMainPassCB(const GameTimer& timer)
{
...
void CrateApp::BuildRenderItems()
{
	...
	boxItem->Mat = m_Materials["woodCrate"].get();
...
void CrateApp::DrawRenderItems(ID3D12GraphicsCommandList* cmdList, const std::vector<Renderable*>& renderables)
{
