...
TessellationApp::TessellationApp(HINSTANCE hInst)
	: D3DApp(hInst)
{
...
void TessellationApp::OnKeyboardInput(const GameTimer& timer)
{
	
}

void TessellationApp::UpdateCamera(const GameTimer& timer)
{
...
void TessellationApp::UpdateObjectCBs(const GameTimer& timer)
{
...
void TessellationApp::UpdateMainPassCB(const GameTimer& timer)
{
...
void TessellationApp::DrawRenderItems(ID3D12GraphicsCommandList* cmdList, const std::vector<Renderable*>& renderables)
{
...
void TessellationApp::BuildShadersAndInputLayout()                       
{
	...
	m_Shaders["TessellationVS"] = D3DUtil::LoadBinary(L"Shaders/" + projectName + L"/Tessellation_VS.cso");
	m_Shaders["TessellationHS"] = D3DUtil::LoadBinary(L"Shaders/" + projectName + L"/Tessellation_HS.cso");
	m_Shaders["TessellationDS"] = D3DUtil::LoadBinary(L"Shaders/" + projectName + L"/Tessellation_DS.cso");
	m_Shaders["TessellationPS"] = D3DUtil::LoadBinary(L"Shaders/" + projectName + L"/Tessellation_PS.cso");
