...
class DynamicIndexingApp : public D3DApp
{
public:
	DynamicIndexingApp(HINSTANCE hInst);
	DynamicIndexingApp(const DynamicIndexingApp& rhs) = delete;
	DynamicIndexingApp& operator=(const DynamicIndexingApp& rhs) = delete;
	~DynamicIndexingApp();
