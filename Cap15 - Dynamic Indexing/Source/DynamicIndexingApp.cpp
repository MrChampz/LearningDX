...
DynamicIndexingApp::DynamicIndexingApp(HINSTANCE hInst)
	: D3DApp(hInst)
{

}

DynamicIndexingApp::~DynamicIndexingApp()
{
...
void DynamicIndexingApp::OnResize()
{
	D3DApp::OnResize();
...
void DynamicIndexingApp::Update(const GameTimer& timer)
{
...
void DynamicIndexingApp::Draw(const GameTimer& timer)
{
...
void DynamicIndexingApp::OnMouseDown(WPARAM btnState, int x, int y)
{
...
void DynamicIndexingApp::OnMouseUp(WPARAM btnState, int x, int y)
{
	ReleaseCapture();
...
void DynamicIndexingApp::OnMouseMove(WPARAM btnState, int x, int y)
{
...
void DynamicIndexingApp::OnKeyboardInput(const GameTimer& timer)
{
...
void DynamicIndexingApp::UpdateObjectCBs(const GameTimer& timer)
{
...
void DynamicIndexingApp::UpdateMainPassCB(const GameTimer& timer)
{
...
void DynamicIndexingApp::UpdateMaterialBuffer(const GameTimer& timer)
{
...
void DynamicIndexingApp::LoadTextures()
{
...
void DynamicIndexingApp::BuildShapesGeometry()
{
...
void DynamicIndexingApp::BuildMaterials()
{
...
void DynamicIndexingApp::BuildRenderItems()
{
...
void DynamicIndexingApp::DrawRenderItems(ID3D12GraphicsCommandList* cmdList, const std::vector<Renderable*>& renderables)
{
...
void DynamicIndexingApp::BuildFrameResources()
{
...
void DynamicIndexingApp::BuildDescriptorHeaps()
{
	// Create the SRV heap.
...
void DynamicIndexingApp::BuildShadersAndInputLayout()                       
{
...
void DynamicIndexingApp::BuildPSOs()
{
...
std::array<const CD3DX12_STATIC_SAMPLER_DESC, 6> DynamicIndexingApp::GetStaticSamplers()
{
