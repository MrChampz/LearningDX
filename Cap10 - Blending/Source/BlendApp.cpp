...
BlendApp::BlendApp(HINSTANCE hInst)
	: D3DApp(hInst)
{
...
void BlendApp::OnKeyboardInput(const GameTimer& timer)
{
...
void BlendApp::AnimateMaterials(const GameTimer& timer)
{
...
void BlendApp::UpdateCamera(const GameTimer& timer)
{
...
void BlendApp::UpdateObjectCBs(const GameTimer& timer)
{
...
void BlendApp::UpdateMaterialCBs(const GameTimer& timer)
{
...
void BlendApp::UpdateMainPassCB(const GameTimer& timer)
{
...
void BlendApp::UpdateWaves(const GameTimer& timer)
{
...
void BlendApp::DrawRenderItems(ID3D12GraphicsCommandList* cmdList, const std::vector<Renderable*>& renderables)
{
