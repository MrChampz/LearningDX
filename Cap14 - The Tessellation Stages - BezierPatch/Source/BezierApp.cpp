...
BezierApp::BezierApp(HINSTANCE hInst)
	: D3DApp(hInst)
{
...
void BezierApp::Update(const GameTimer& timer)
{
...
void BezierApp::Draw(const GameTimer& timer)
{
...
void BezierApp::OnKeyboardInput(const GameTimer& timer)
{
	
}

void BezierApp::UpdateCamera(const GameTimer& timer)
{
...
void BezierApp::UpdateObjectCBs(const GameTimer& timer)
{
...
void BezierApp::UpdateMainPassCB(const GameTimer& timer)
{
...
void BezierApp::DrawRenderItems(ID3D12GraphicsCommandList* cmdList, const std::vector<Renderable*>& renderables)
{
...
void BezierApp::BuildShadersAndInputLayout()                       
{
	...
	m_Shaders["BezierVS"] = D3DUtil::LoadBinary(L"Shaders/" + projectName + L"/Bezier_VS.cso");
	m_Shaders["BezierHS"] = D3DUtil::LoadBinary(L"Shaders/" + projectName + L"/Bezier_HS.cso");
	m_Shaders["BezierDS"] = D3DUtil::LoadBinary(L"Shaders/" + projectName + L"/Bezier_DS.cso");
	m_Shaders["BezierPS"] = D3DUtil::LoadBinary(L"Shaders/" + projectName + L"/Bezier_PS.cso");
