...
class TexShapesApp : public D3DApp
{
public:
	TexShapesApp(HINSTANCE hInst);
	TexShapesApp(const TexShapesApp& rhs) = delete;
	TexShapesApp& operator=(const TexShapesApp& rhs) = delete;
	~TexShapesApp();
